...
class AopCertClient
{
     ...
     */
    private function setupCharsets(Request $request)
    {
    ...
    public function parserJSONSignData(Request $request, $responseContent, $responseJSON)
    {
    ...
    public function parserJSONSignSource(Request $request, $responseContent)
    {
    ...
    public function parserXMLSignData(Request $request, $responseContent)
    {
        $signData = new SignData();
    ...
    public function parserXMLSignSource(Request $request, $responseContent)
    {
        $apiName = $request->getApiMethodName();
        $rootNodeName = str_replace(".", "_", $apiName) . $this->RESPONSE_SUFFIX;
        $rootIndex = strpos($responseContent, $rootNodeName);
    ...
    public function parserResponseSubCode(Request $request, $responseContent, $respObject, $format)
    {
        if ("json" == $format) {
            $apiName = $request->getApiMethodName();
            $rootNodeName = str_replace(".", "_", $apiName) . $this->RESPONSE_SUFFIX;
     ...
     * @throws \Exception
     */
    public function checkResponseSign(Request $request, $signData, $resp, $respObject)
    {
    ...
    private function parserEncryptXMLSignSource(Request $request, $responseContent)
    {
        $apiName = $request->getApiMethodName();
        $rootNodeName = str_replace(".", "_", $apiName) . $this->RESPONSE_SUFFIX;
        $rootIndex = strpos($responseContent, $rootNodeName);
    ...
    private function encryptXMLSignSource(Request $request, $responseContent)
    {
