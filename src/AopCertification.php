 ...
 * 验证支付宝公钥证书是否可信
 *
 * @param $alipayCert null 支付宝公钥证书
 * @param $rootCert   null 支付宝根证书
 *
 * @return bool
 */
 ...
 * 验证证书链是否是信任证书库中证书签发的
 *
 * @param $alipayCerts null 目标验证证书列表
 * @param $rootCerts   null 可信根证书列表
 *
 * @return bool
 */
 ...
 * 向上构造证书链
 *
 * @param $subjectMap null 主题和证书的映射
 * @param $certChain  null 证书链
 * @param $current    null 当前需要插入证书链的证书，include
 */
 ...
 * 向下构造证书链
 *
 * @param $issuerMap null 签发者和证书的映射
 * @param $certChain null 证书链
 * @param $current   null  当前需要插入证书链的证书，exclude
 *
 * @return mixed
 */
 ...
 *
 * @param null $certPem   - PEM encoded cert
 * @param null $caCertPem - PEM encoded cert that possibly signed $cert
 *
 * @return bool
 */
